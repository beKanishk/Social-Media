...
//     setIsFollowing(optimisticState);
//     try {
//       dispatch(createFollower(userId, localStorage.getItem("jwt")));
//     } catch (error) {
//       setIsFollowing(!optimisticState);
//       console.error("Follow/Unfollow failed:", error);
//     }
//   };
//   const isOwnProfile = user && userProfile && String(user.id) === String(userProfile.id);
...
//           />
//           <div className="flex-1">
//             <h2 className="text-2xl font-bold text-gray-800">xyxz</h2>
//             <p className="text-blue-500 text-sm">@{userProfile?.userName}</p>
//             <p className="text-sm text-gray-600 mt-1">{userProfile?.bio}</p>
//             <div className="mt-2 text-sm text-gray-700">
//               <span className="font-semibold">{userProfile?.follower?.length || 0}</span> Followers ·{" "}
...
//               className="px-5 py-2 rounded-full font-medium bg-yellow-500 hover:bg-yellow-600 text-white transition duration-300"
//             >
//               Edit Profile
//             </button>
//           ) : (
...
//       {editModalOpen && (
//         <EditProfileModal user={userProfile} onClose={() => setEditModalOpen(false)} />
//       )}
//     </div>
//   );
// };
