...
// console.log("User" ,user);
  ...
  return (
  <div className="mt-4 bg-white dark:bg-gray-900 p-4 rounded-b-xl border-t border-gray-200 dark:border-gray-800">
    <form onSubmit={handleAddComment} className="flex items-center space-x-2">
      <input
        ...
        className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-300 dark:bg-gray-800 dark:text-white"
      />
      <button
        type="submit"
    ...
    <div className="mt-4 space-y-4">
      {comments.map((comment) => {
        ...
        return (
          <div
            key={comment.id}
            className="flex items-start space-x-3 bg-gray-50 dark:bg-gray-800 p-3 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700"
          >
            <img
              src="/avatar.png"
              alt="User avatar"
            ...
            <div className="flex-1">
              <div className="flex justify-between items-center">
                <span className="font-semibold text-gray-800 dark:text-indigo-300">
