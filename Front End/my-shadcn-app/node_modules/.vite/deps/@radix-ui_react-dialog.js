...
var RemoveScroll = React35.forwardRef(function(props, parentRef) {
  ...
  return React35.createElement(
    React35.Fragment,
    null,
    enabled && React35.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime13.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React40.Children.map(children, (child) => (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime13.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
